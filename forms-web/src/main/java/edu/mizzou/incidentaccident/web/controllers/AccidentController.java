...
public class AccidentController {
	...
	public String generateSignatureImage(ModelMap map) {
		map.addAttribute("signatureForm", new SignatureModel());
		return "accident.signature";
	}
	
	@RequestMapping(value="/signature", method=RequestMethod.POST)
	public String saveSignatureImage(@ModelAttribute("signatureForm") SignatureModel signature, BindingResult result, ModelMap map) {
